...
procedure nast(var obiekt : string; var koniec : Boolean);
procedure restart(var obiekt : string);
procedure dodaj(var obiekt : string; var counter : Integer);
procedure delete(var obiekt : string; var counter : Integer);
procedure zapisz1(var obiekt : string);
procedure zapisz2(var obiekt : string);
procedure clean();
